...
\title{An Evaluation of the Frequency Independence Assumption of Power System Coefficients used in Geomagnetically Induced Current Estimates}
...
The primary implications of the results presented are (1) significantly improved estimates of GICs using data-derived system coefficients $a$ and $b$ can be made if they are allowed to be frequency dependent and (2) $a$ and $b$ coefficients derived using a traditional frequency-independent model may differ significantly from those computed using power system configuration information.

%a direct comparison of data-derived $a$ and $b$ coefficients and those computed using power system configuration information will be problematic if the data are not consistent with the frequency independent assumption.
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{plot_raw_All_20060805-v1.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{plot_GIC_predictions-MeanModel-2006-08-06-v0-o0.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{plot_model_summary_SN-options-1-v0-o0.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{plot_model_summary_aobo_histograms-options-1-v0-o0.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{plot_model_summary_Z-options-1-v0-o0.pdf}
  ...
  %\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{plot_model_summary_Phi-options-1-v1-o0.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{plot_model_summary_Z_MT-options-1-v0-o0.pdf}
  ...
  %\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{plot_model_summary_Phi_MT-options-1-v1-o0.pdf}

...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/plot_TF_aves_aobo_histograms-none-none-rectangular-parzen-ols_on_Z.pdf}
\caption{}
\label{histogram}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/plot_TF_aves_GE_H-none-none-rectangular-parzen-ols_on_Z.pdf}
\caption{}
\label{H}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/plot_TF_aves_GE_Z-none-none-rectangular-parzen-ols_on_Z.pdf}
\caption{}
\label{Z}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/plot_TF_aves_GE_Phi-none-none-rectangular-parzen-ols_on_Z.pdf}
\caption{}
\label{Phi}
\end{figure}

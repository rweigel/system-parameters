...
One-second-cadence electric and magnetic field measurements from Memanbetsu Magnetic Observatory (geodetic latitude: 43.910 N, geodetic longitude: 144.189 E) were obtained from the Japan Meteorological Agency data portal. The location of the observatory and substation are shown in Figure~\ref{map}.
...
\caption{Locations of measurement sites for GIC, at the Memanbetsu substation, and the geoelectric and geomagnetic field measurement site at Memambetsu Magnetic Observatory. The distance from the observatory to the substation is $\sim$9 km.}
\label{map}
\end{figure}

...
\caption{Out-of-sample model predictions and predictions errors for a 1-day interval. The bottom overlapping traces are the measured GIC (black line) and the model predictions (colored lines). The prediction error of each model is shown shifted by an arbitrary offset.}
\label{predictions}
\end{figure}

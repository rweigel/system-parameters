...
%DIF DEL paper-submitted-1.tex   Thu Jun 27 16:14:26 2019
%DIF ADD paper.tex               Tue Jul  9 14:25:53 2019
\usepackage{apacite}
%DIF 3c3
...
\begin{table}
\caption{\DIFaddFL{Periods associated with evaluation frequency bands used for regression and smoothing spectra. \# is the evaluation frequency number, $N$ is the number of DFT points in the window, and $T_e=1/f_e$. The window range is $T_l$ through $T_h$.}}
\centering
